...
public final class ControlDelay extends Table {
  public static ControlDelay getRootAsControlDelay(ByteBuffer _bb) { return getRootAsControlDelay(_bb, new ControlDelay()); }
  public static ControlDelay getRootAsControlDelay(ByteBuffer _bb, ControlDelay obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public ControlDelay __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createControlDelay(FlatBufferBuilder builder,
      int timeOffset,
      int dataOffset) {
    builder.startObject(2);
    ControlDelay.addData(builder, dataOffset);
    ControlDelay.addTime(builder, timeOffset);
    return ControlDelay.endControlDelay(builder);
  }

  public static void startControlDelay(FlatBufferBuilder builder) { builder.startObject(2); }
  ...
  public static int endControlDelay(FlatBufferBuilder builder) {
